...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    // Verifica a autenticidade do Token, atraves de "traduzir" o email e roles que foram gerados para esse token
    ...
    private UsernamePasswordAuthenticationToken getAuth(String token) {
        ...
        if (Objects.nonNull(email)) {
            return new UsernamePasswordAuthenticationToken(email, null, List.of(new SimpleGrantedAuthority(roles.get(0))));
        } else {
            return null;
        }
    }
